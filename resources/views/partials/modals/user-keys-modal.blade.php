<div class="modal fade" id="userPrivateKeys" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            ...
            <form id="save-session-private-keys">
                ...
                <div class="modal-body">
                    <div>
                        ...
                        *If the messages do not load correctly close the session and start it again and verify that the
                        keys
                        are correct.<br>
